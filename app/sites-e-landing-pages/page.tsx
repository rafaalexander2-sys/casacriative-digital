        ...
        <div style={{ maxWidth: 780, margin: '0 auto' }}>
          ...
          <div className="r3" style={{ gap: 12 }}>
            {[
              ...
              { titulo: 'Landing Page – Odontologia 2', tag: 'Landing Page', img: 'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200_webp/bf3fc0244029633.698dea0a7b92a.png', href: 'https://www.behance.net/gallery/244029633/LandingPage-Odontologia' },
            ].map((c, i) => (

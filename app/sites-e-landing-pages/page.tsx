        ...
        <div style={{ maxWidth: 780, margin: '0 auto' }}>
          ...
          <div className="r3" style={{ gap: 12 }}>
            {[
              ...
              { titulo: 'Landing Page – Odontológico', tag: 'Landing Page', img: 'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200_webp/c59561242480249.696e3e2bd04f8.png', href: 'https://www.behance.net/gallery/242480249/Landing-Page-Odontologico' },
              { titulo: 'Landing Page – Odontologia 2', tag: 'Landing Page', img: 'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200_webp/96a65d244029633.698dea0a7b10f.png', href: 'https://www.behance.net/gallery/244029633/LandingPage-Odontologia' },
            ].map((c, i) => (

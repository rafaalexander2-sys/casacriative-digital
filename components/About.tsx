...
export default function About() {
  return (
    <section style={{ background: '#000', padding: '100px 0' }}>
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
        <div>
        ...
        <div style={{ position: 'relative', height: 360, borderRadius: 10, overflow: 'hidden', background: 'linear-gradient(135deg, #1a1a1a 0%, #2a1a0a 50%, #1a1a1a 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '0.5px solid #3a3a3c' }}>
